...
const Auth = (() => {
        ...
        <div class="card mb-2">
          ...
          <div class="form-group">
            ...
            <select class="form-input" id="prof-regime-tva">
              ...
              <option value="reel_simplifie" ${profile.regimeTVA === 'reel_simplifie' ? 'selected' : ''}>Réel simplifié</option>
              <option value="reel_normal" ${profile.regimeTVA === 'reel_normal' ? 'selected' : ''}>Réel normal</option>
              <option value="auto" ${profile.regimeTVA === 'auto' ? 'selected' : ''}>Auto-entrepreneur / Micro</option>
            </select>
          </div>
          <div class="form-group">
  ...
  function onAuthStateChanged(user) {
    ...
    if (user) {
      ...
      // Afficher le changelog si nouvelle version
      setTimeout(() => Changelog.checkAndShow(), 800);
    } else {
      UI.hideAppShell();
      UI.navigateTo('login');
    }
