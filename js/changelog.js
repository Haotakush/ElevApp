  ...
  function showChangelog(showAll = false) {
    ...
    const html = `
      <div style="max-height:70vh;overflow-y:auto;">
        ...
        ${!showAll && VERSIONS.length > 1 ? `
          <button class="btn btn-secondary btn-block btn-sm mt-2" id="changelog-show-all">
    ...
    UI.openModal(html, {
      onOpen: () => {
        ...
        document.getElementById('changelog-show-all')?.addEventListener('click', () => {
          UI.closeModal();
          setTimeout(() => showChangelog(true), 300);
        });
      }
    });
