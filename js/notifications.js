    ...
    return `
      <div class="card mb-2" id="notif-banner" style="border-left:3px solid var(--blue);background:var(--bg-secondary);">
        <div style="display:flex;align-items:center;gap:10px;">
          ...
          <button class="btn btn-primary btn-sm" data-action="notif-request-permission">Activer</button>
          <button class="btn btn-secondary btn-sm" style="padding:6px 8px;" data-action="notif-dismiss-banner">✕</button>
        </div>
      </div>
    `;
  }
