    ...
    UI.setContent(`
      ...
      <form id="externe-form">
        ...
        <div class="form-group">
          ...
          <input class="form-input" type="date" id="ext-dateNaissance" value="${externe.dateNaissance ? Utils.formatDateISO(externe.dateNaissance) : ''}">
        </div>
    ...
    document.getElementById('externe-form').addEventListener('submit', async (e) => {
      ...
      const data = {
        ...
        dateNaissance: document.getElementById('ext-dateNaissance').value
          ? firebase.firestore.Timestamp.fromDate(new Date(document.getElementById('ext-dateNaissance').value))
          : null,
        proprietaire: {
