      ...
      if (externes.length === 0) {
        listEl.innerHTML = `
          <div class="empty-state">
            ...
            <button class="btn btn-primary" data-nav="externe-form">+ Ajouter un animal</button>
          </div>
        `;
        return;
      }
    ...
    try {
      ...
      UI.setContent(`
        ...
        <div style="display:flex;gap:10px;margin-bottom:16px;">
          <button class="btn btn-secondary" style="flex:1;" data-nav="externe-form" data-params='{"id":"${externeId}"}'>✏️ Modifier</button>
