...
const Legal = (() => {
  ...
  function render() {
    UI.setContent(`
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:4px;">
        <a href="mentions-legales.html" target="_blank" style="text-decoration:none;">
          <div class="card" style="text-align:center;padding:16px 12px;border:2px solid var(--accent-light,#fcebd8);">
            <div style="width:40px;height:40px;background:var(--accent-light);border-radius:10px;display:flex;align-items:center;justify-content:center;color:var(--accent);margin:0 auto 6px;">${Icons.get('fileText', 22)}</div>
        ...
        <a href="confidentialite.html" target="_blank" style="text-decoration:none;">
          <div class="card" style="text-align:center;padding:16px 12px;border:2px solid var(--accent-light,#fcebd8);">
            <div style="width:40px;height:40px;background:var(--accent-light);border-radius:10px;display:flex;align-items:center;justify-content:center;color:var(--accent);margin:0 auto 6px;">${Icons.get('alertCircle', 22)}</div>
      ...
      <div class="section-title"><div class="section-icon">${Icons.get('phone', 18)}</div> Éditeur de l'application</div>
      <div class="card mb-2">
        <div class="info-row">
      ...
      <div class="section-title"><div class="section-icon">${Icons.get('alertCircle', 18)}</div> Politique de confidentialité</div>
      <div class="card mb-2">
      ...
      <!-- Données collectées -->
      <div class="section-title"><div class="section-icon">${Icons.get('health', 18)}</div> Données collectées</div>
      <div class="card mb-2">
      ...
      <!-- Finalités -->
      <div class="section-title"><div class="section-icon">${Icons.get('checkCircle', 18)}</div> Finalités du traitement</div>
      <div class="card mb-2">
      ...
      <!-- Base légale -->
      <div class="section-title"><div class="section-icon">${Icons.get('scale', 18)}</div> Base légale</div>
      <div class="card mb-2">
        <p style="font-size:0.82rem;line-height:1.6;margin:0;">
      ...
      <div class="section-title"><div class="section-icon">${Icons.get('health', 18)}</div> Hébergement et sécurité</div>
      <div class="card mb-2">
      ...
      <div class="section-title"><div class="section-icon">${Icons.get('bell', 18)}</div> Durée de conservation</div>
      <div class="card mb-2">
        <p style="font-size:0.82rem;line-height:1.6;margin:0;">
      ...
      <div class="section-title"><div class="section-icon">${Icons.get('checkCircle', 18)}</div> Vos droits (RGPD)</div>
      <div class="card mb-2">
        <p style="font-size:0.82rem;line-height:1.6;margin:0 0 8px 0;">
      ...
      <!-- Cookies -->
      <div class="section-title"><div class="section-icon">${Icons.get('info', 18)}</div> Cookies</div>
      <div class="card mb-2">
        <p style="font-size:0.82rem;line-height:1.6;margin:0;">
      ...
      <!-- Sous-traitants -->
      <div class="section-title"><div class="section-icon">${Icons.get('user', 18)}</div> Sous-traitants</div>
      <div class="card mb-2">
        <div class="info-row">
