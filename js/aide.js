  ...
  function render() {
    const html = `
      ...
      <div class="card mb-2" style="display:flex;align-items:center;gap:12px;">
        ...
        <button class="btn btn-primary btn-sm" onclick="Onboarding.show()">Lancer</button>
      </div>
      ...
      <div style="margin-top:8px;" id="aide-sections">
        ${SECTIONS.map((section, si) => `
          <div class="card mb-2" style="padding:0;overflow:hidden;">
            ...
            <button
              onclick="Aide._toggleSection(${si})"
            ...
            >
              ...
              <span id="aide-section-chevron-${si}" style="color:var(--text-muted);transition:transform 0.2s;font-size:0.8rem;">▼</span>
            </button>
            ...
            <div id="aide-section-${si}" style="display:none;border-top:1px solid var(--border);">
              ${section.items.map((item, ii) => `
                <div style="padding:0;${ii < section.items.length - 1 ? 'border-bottom:1px solid var(--border);' : ''}">
                  <!-- Question -->
                  <button
                    onclick="Aide._toggleItem(${si}, ${ii})"
                  ...
                  >
                    ...
                    <span id="aide-item-chevron-${si}-${ii}" style="color:var(--text-muted);font-size:0.75rem;flex-shrink:0;margin-top:2px;">▶</span>
                  </button>
                  <!-- Réponse -->
      ...
      <div style="text-align:center;padding:16px 0;font-size:0.78rem;color:var(--text-muted);">
        ...
        <button style="background:none;border:none;color:var(--primary);font-size:0.78rem;cursor:pointer;padding:0;" onclick="Changelog.showChangelog(true)">
          Voir le changelog
        </button>
      </div>
    `;
