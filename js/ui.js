...
const UI = (() => {
  ...
  function updateNavActive(page) {
    ...
    const morePages = ['health', 'health-form', 'exports', 'calendrier', 'externes', 'externe-detail', 'externe-form', 'registre', 'autocontrole', 'autocontrole-detail', 'cession-form', 'aide'];
  ...
  function showHelp(titre, contenu) {
    openModal(`
      <div>
        ...
        <button class="btn btn-primary btn-block" onclick="UI.closeModal()">Compris</button>
      </div>
    `);
  }
