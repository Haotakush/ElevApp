...
const Chaleurs = (() => {
    ...
    try {
      ...
      container.innerHTML = `
        ...
        <div style="display:flex;gap:8px;margin-bottom:16px;">
          <button class="btn btn-primary" style="flex:1;" data-nav="chaleur-form" data-params='{"animalId":"${animalId}"}'>+ Nouvelle chaleur</button>
    ...
    return `
      <div class="card mb-2">
        ...
        <div style="margin-top:6px;font-size:0.78rem;border-top:1px solid var(--border);padding-top:6px;">
          🍼 <a href="#" data-nav="portee-detail" data-params='{"id":"${c.porteeId}"}' style="color:var(--blue);">Voir la portée associée →</a>
        </div>` : ''}
  ...
  async function renderForm(animalId, chaleurId) {
    ...
    try {
      ...
      container.innerHTML = `
        <form id="chaleur-form">
          ...
          <div class="section-title" style="display:flex;align-items:center;justify-content:space-between;">
            ...
            <button type="button" id="help-proges-btn" style="background:none;border:none;cursor:pointer;font-size:1rem;color:var(--text-muted);padding:0;">ℹ️</button>
          </div>
          <div class="card mb-2">
              ...
              <div style="border-top:1px solid var(--border);padding-top:12px;margin-top:8px;">
                ...
                <div id="mammite-notes-group" style="display:${c.mammite ? 'block' : 'none'};margin-top:10px;padding:10px;border-radius:var(--radius-md);background:rgba(239,68,68,0.06);border:1px solid rgba(239,68,68,0.2);">
                  <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">
                    ...
                    <button type="button" id="help-mammite-btn" style="background:none;border:none;cursor:pointer;font-size:1rem;color:var(--text-muted);padding:0;">ℹ️</button>
                  </div>
                  <div class="form-group">
      ...
      // Boutons aide ℹ️
      document.getElementById('help-proges-btn')?.addEventListener('click', () => {
        UI.showHelp('Suivi progestérone', 'Le suivi progestérone permet de déterminer le moment optimal pour la saillie.<br><br>• <strong>J0</strong> = jour du premier pic LH (progestérone ≈ 2 ng/mL)<br>• <strong>J2</strong> = ovulation (progestérone ≈ 5–8 ng/mL)<br>• <strong>J4–J6</strong> = période optimale de saillie (≥ 10 ng/mL)<br><br>Les valeurs peuvent varier selon le laboratoire. Consultez votre vétérinaire pour interpréter les résultats.');
      });
      document.getElementById('help-mammite-btn')?.addEventListener('click', () => {
        UI.showHelp('Mammite post-partum', 'La mamelle comporte plusieurs quartiers :<br><br>• <strong>AG</strong> = Antérieur Gauche<br>• <strong>AD</strong> = Antérieur Droit<br>• <strong>PG</strong> = Postérieur Gauche<br>• <strong>PD</strong> = Postérieur Droit<br><br>Cochez les quartiers atteints, notez le traitement prescrit par votre vétérinaire et suivez l\'évolution (résolutive, chronique, récidivante).');
      });
