          ...
          return `
            <div class="timeline-item ${isAlert ? 'alert' : ''}">
              <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:8px;">
                <div style="flex:1;cursor:pointer;" onclick="UI.navigateTo('animal-detail', {id:'${entry.animalId}'})">
                ...
                <div style="display:flex;gap:4px;flex-shrink:0;margin-top:2px;">
                  <button onclick="UI.navigateTo('health-form',{animalId:'${entry.animalId}',entryId:'${entry.id}'})"
                  ...
                  <button onclick="Health._deleteEntry('${entry.animalId}','${entry.id}')"
