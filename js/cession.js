    ...
    try {
        ...
        <form id="cession-form">
          ...
          <div class="card mb-2">
            ...
            <div class="form-group">
              ...
              <input class="form-input" type="date" id="cess-date" required value="${new Date().toISOString().split('T')[0]}">
            </div>
          </div>
          ...
          <div class="card mb-2">
            ...
            <label class="form-toggle mb-1">
              <input type="checkbox" id="cess-doc-lof">
              <span>Certificat LOF / LOOF</span>
            </label>
            <label class="form-toggle mb-1">
      ...
      document.getElementById('cession-form').addEventListener('submit', async (e) => {
        ...
        const cessionData = {
          ...
          date: document.getElementById('cess-date').value,
          acquereur: {
          ...
          documents: {
            ...
            lof: document.getElementById('cess-doc-lof').checked,
    ...
    try {
      ...
      if (isVente) {
        mentions.push(
          ...
          ``,
          `GARANTIE DE CONFORMITÉ (Art. L217-4 Code de la consommation) : le vendeur professionnel est tenu de livrer`,
          `un animal conforme au contrat. Délai d'action : 2 ans à compter de la délivrance.`,
          ``,
          `DROIT DE RÉTRACTATION — En cas de vente à distance, l'acquéreur dispose d'un délai de 14 jours pour exercer`,
          `son droit de rétractation (Art. L221-18 Code de la consommation).`
        );
      }
