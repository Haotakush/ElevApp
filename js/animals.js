    ...
    try {
      ...
      UI.setContent(`
        ...
        <div class="quick-actions mb-2">
          <button class="quick-action-btn" data-nav="health-form" data-params='{"animalId":"${animalId}","type":"vaccin"}'>💉 Vaccin</button>
          <button class="quick-action-btn" data-nav="health-form" data-params='{"animalId":"${animalId}","type":"traitement"}'>💊 Traitement</button>
          <button class="quick-action-btn" data-nav="health-form" data-params='{"animalId":"${animalId}","type":"visite_veto"}'>🏥 Visite véto</button>
          <button class="quick-action-btn" data-nav="health-form" data-params='{"animalId":"${animalId}","type":"chirurgie"}'>🔪 Chirurgie</button>
          <button class="quick-action-btn" data-nav="health-form" data-params='{"animalId":"${animalId}","type":"pesee"}'>⚖️ Pesée</button>
          <button class="quick-action-btn" data-nav="cession-form" data-params='{"animalId":"${animalId}"}'>📜 Cession</button>
          ${animal.sexe === 'femelle' && animal.statutReproducteur !== 'sterilise' ? `<button class="quick-action-btn" data-nav="chaleur-form" data-params='{"animalId":"${animalId}"}'>🌡️ Chaleur</button>` : ''}
        </div>

        <!-- Boutons éditer / supprimer -->
        <div style="display:flex;gap:10px;margin-bottom:16px;">
          <button class="btn btn-secondary" style="flex:1;" data-nav="animal-form" data-params='{"id":"${animalId}"}'>✏️ Modifier</button>
