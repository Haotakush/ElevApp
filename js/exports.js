...
const Exports = (() => {
  ...
  // Helper: ouvre le PDF dans un nouvel onglet/fenêtre du navigateur système.
  // window.open(_blank) sur iOS PWA ouvre Safari (hors app), préservant l'app shell intact.
  // Si les popups sont bloqués, fallback sur un lien <a download>.
  function _downloadPDF(doc, fileName) {
    ...
    // Révoquer après 10 s (assez pour que le navigateur ait ouvert l'URL)
