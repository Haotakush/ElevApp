...
const CACHE_NAME = 'elevapp-2026-04-10d';
const STATIC_ASSETS = [
  './',
  'index.html',
  'app.html',
...
self.addEventListener('install', (event) => {
  ...
  // NE PAS appeler self.skipWaiting() ici — cela rechargerait la page automatiquement
  // même pendant une opération critique (export PDF). Le skipWaiting est déclenché
  // uniquement par l'utilisateur via le bouton "Mettre à jour" (message SKIP_WAITING).
});
