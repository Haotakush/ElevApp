...
const CACHE_NAME = 'elevapp-2026-03-26b';
const STATIC_ASSETS = [
  './',
  'index.html',
  'css/style.css',
...
self.addEventListener('install', (event) => {
  ...
  // Ne pas appeler skipWaiting() ici — on attend le message explicite
  // pour afficher la bannière "Mettre à jour" à l'utilisateur
});
